class CityData {
  static final Map<String, List<String>> citiesAndDistricts = {
    ...
    'Ankara': [
      'Akyurt', 'Altındağ', 'Ayaş', 'Balâ', 'Beypazarı', 'Çamlıdere', 'Çankaya', 'Çubuk', 'Elmadağ', 'Etimesgut', 'Evren', 'Gölbaşı', 'Güdül', 'Haymana', 'Kahramankazan', 'Kalecik', 'Keçiören', 'Kızılcahamam', 'Mamak', 'Nallıhan', 'Polatlı', 'Pursaklar', 'Sincan', 'Şereflikoçhisar', 'Yenimahalle'
    ],
    'Antalya': [
    ...
    'Isparta': [
      'Aksu', 'Atabey', 'Eğirdir', 'Gelendost', 'Gönen', 'Keçiborlu', 'Merkez', 'Şarkikaraağaç', 'Senirkent', 'Sütçüler', 'Uluborlu', 'Yalvaç', 'Yenişarbademli'
    ],
    'İstanbul': [
  ...
  static List<String> getDistrictsOfCity(String city) {
